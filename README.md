...
![Unreal Engine](https://img.shields.io/badge/Unreal_Engine-5-black?style=flat&logo=unrealengine&logoColor=white)
![C#](https://img.shields.io/badge/C%23-Language-239120?style=flat&logo=csharp&logoColor=white)
![Blueprints](https://img.shields.io/badge/Blueprints-Visual_Scripting-005C9F?style=flat&logo=unrealengine&logoColor=white)
![Behavior Trees](https://img.shields.io/badge/AI-Behavior_Trees-red?style=flat)
![PCG](https://img.shields.io/badge/Tech-Proc_Gen-purple?style=flat)

---

### 🚀 Featured Projects

| Project | Role | Key Tech / Focus |
| :--- | :--- | :--- |
| **[Dungeon Flux](https://github.com/davidtius/DungeonFlux)** | Solo Dev | **Dynamic Difficulty Adjustment (DDA)**, PCG, Behavior Trees, User Modeling. |
| **[Gang Dolly](https://github.com/davidtius/GangDollyRevitalization)** | Lead Dev | **Unreal Engine 5**, Environmental Visualization, Blueprint Scripting. |
| **[Anti-Bullying Game](https://github.com/davidtius/Anti-BullyingAdventure)** | Designer | **Psychology-based Mechanics**, Narrative Design, PKM-Karsa Cipta Awardee. |
| **[Turn-Based AI](https://github.com/davidtius/Turn-BasedStrategy)** | AI Dev | **Minimax Algorithm**, Decision Making, Strategy Logic |
| **[Boids Flocking Sim](https://github.com/davidtius/BoidsFlockingSimulation)** | Programmer | **Swarm Intelligence**, Vector Math, Composite Steering Behaviors. |
